...
# IMPORTANT:
# I think there are some errors with the batch optimization. Because of 
# that, I am currently going to remove it from this strong-scaled test.

RUNS=4
COUNTS="1 2 4 8 16 24"

FULL_PATH="/vast/users/tbitsky/llm.c/"
OUTPUT="$FULL_PATH/scaling_tests/strong_results_xkomp_no_tdg.csv"
...
do
    ...
    export OMP_TASKGRAPH_OPT=""

    for run in $(seq 1 $RUNS);
    do 
        EXE_OUTPUT=$(cd $FULL_PATH && ./train_gpt2_xkrt)
